...
class Searching:
    def __init__(self, root, AlgoNameVar):
        ...
        self.algo_menu.config(font="calibri", bg="#7CC1D7", activebackground="#ADD8E6", cursor="circle")
        ...
        self.btn_new = Button(self.frame_btn1, text="Generate", padx=13, pady=3, command=self.new_list, bg="black",
        ...
        self.btn_shuffle = Button(self.frame_btn1, text="Shuffle", padx=13, pady=3, command=self.shuffle_list,
                                  bg="Black", fg="azure", cursor="hand2")
        self.btn_shuffle.place(relx=0.60, rely=0)

        # text box for search entry
        self.search_element = Entry(self.frame1, width=24, bd=3, bg='white')
        ...
        self.scale_size = Scale(self.frame1, label="Size :", orient=HORIZONTAL, from_=10, to=200, length=230,
                                bg="white", troughcolor="#024e76", variable=self.size_var,
        ...
        self.scale_speed = Scale(self.frame1, label="Speed :", orient=HORIZONTAL, from_=1, to=500, length=230,
                                 bg="white", troughcolor="#024e76", variable=self.speed_var,
        ...
        self.label_comparison = Label(self.frame1, text="No. of comparisons: 0", bg="#003366", fg="white",
                                      font=("Fixedsys", 14))
        self.label_comparison.place(relx=0.1, rely=0.65)

        # Label for showing the searched element index
        self.label_index = Label(self.frame1, text="", bg="gray", fg="#003366",
                                 font=("Fixedsys", 12))
        self.label_index.place(relx=0.2, rely=0.58)

        # Frame for algorithm info
        self.frame_algo_info = Frame(self.frame1, bg="#4BAAC8", width=230, height=150, relief="sunken", bd=4)
        self.frame_algo_info.grid_propagate(0)
        self.frame_algo_info.place(relx=0.03, rely=0.7)
        # Label for algorithm info
        self.label_avg = Label(self.frame_algo_info, bg="#4BAAC8", fg="#DEEFF5",
        ...
        self.canva = Canvas(self.frame2, width=self.CANVAS_X, height=self.CANVAS_Y, bg="#3187A2")
        self.canva.pack()
        ...
        for num in self.numbers:
            self.canva.create_rectangle(self.starting_point, self.CANVAS_Y - num, self.starting_point + self.rec_width,
                                        self.CANVAS_Y, fill="#DEEFF5")
            self.label_value = Label(self.canva, text=num, bg="#DEEFF5", fg="midnight blue", font=("Fixedsys", 12))
    ...
    def paint(self, colortype):
        ...
        for i in range(len(self.numbers)):
            ...
            self.label_value = Label(self.canva, text=self.numbers[i], bg="#DEEFF5",
                                     fg="midnight blue",
                                     font=("Fixedsys", 12))

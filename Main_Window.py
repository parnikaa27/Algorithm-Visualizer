...
class Window:
    def __init__(self, root):
        ...
        self.MainLabel = Label(self.root, text='Algorithm Visualizer', bg="#003366", fg="white",
                               font=("calibri italic", 30))
        self.MainLabel.pack(pady=60)
        ...
        self.AlgoTypeList.config(bg="black", activebackground="gray",fg="white", cursor="hand2")
        self.AlgoNameList = OptionMenu(self.root, self.AlgoNameVar, 'None')
        self.AlgoNameList.config(bg="black", activebackground="gray", fg="white",cursor="hand2")
        # label of the two dropdown menus
        self.AlgoTypeVar.set("Select Algorithm Type")
        self.AlgoNameVar.set("Select Algorithm")
        self.AlgoTypeList.pack(pady=8)
        self.AlgoNameList.pack(pady=8)

        # next button
        self.NextButton = Button(self.root, text="Next>", bg="white", fg="black" ,activebackground="gray",
                                 command=self.Run1)
    ...
    def Run1(self):
        ...
        # if backtracking is selected
            ...
            if self.AlgoNameVar.get() == "Sudoku":
                ...
                frame = Frame(self.root, width=300, height=150, bg="darkblue")
